...
var vk_DEBUG = false,
    ENABLE_CACHE = false,
    LOAD_HEADERS_BY_HEAD_REQ = false; // РґР»СЏ РїРѕР»СѓС‡РµРЅРёСЏ Р·Р°РїСЂРѕСЃРѕРј С‚РѕР»СЊРєРѕ С…РёРґРµСЂРѕРІ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ HEAD Р·Р°РїСЂРѕСЃ (РёРЅР°С‡Рµ GET c С…РёРґРµСЂРѕРј Р·Р°РїСЂРѕСЃР° Range: bytes=0-1)
...
/* FUNCTIONS. LEVEL 1 */
   ...
   function print_r( array) {
      ...
      var formatArray = function (obj, cur_depth, pad_val, pad_char) {
         ...
         if(typeof obj=='object' || typeof obj=='array' || (obj.length>0 && typeof obj!='string' && typeof obj!='number')) { // typeof obj=='array' РЅРµ СЃСѓС‰РµСЃС‚РІСѓРµС‚
   ...
   function vkopt_brackets(s){
	...
	function vkExtendLang(obj) {    // РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РІ РЅРµРєРѕС‚РѕСЂС‹С… РїР»Р°РіРёРЅР°С… Рє РІРєРѕРїС‚Сѓ. РўР°Рј СѓР·РєРѕСЃРїРµС†РёР°Р»РёР·РёСЂРѕРІР°РЅРЅС‹Рµ СЃРєСЂРёРїС‚С‹ РїРѕ РјРµР»РѕС‡Р°Рј. Р§РµР»РѕРІРµРє 5 РёСЃРїРѕР»СЊР·СѓРµС‚.
   ...
   function FindAndProcessTextNodes(node,func){
	...
	function vkSetVal(key,val){
     ...
     window.vkopt_ready && vk_settings.backup_handler(); // СЃРѕС…СЂР°РЅРµРЅРёРµ РґР°РјРїР° РЅР°СЃС‚СЂРѕРµРє РІ С…СЂР°РЅРёР»РёС‰Рµ СЂР°СЃС€РёСЂРµРЅРёСЏ (РЅРµ РґРѕРјРµРЅР° vk.com)
	}
	...
	function getSet(num,type) {
      ...
      if (!SettBit) {
          ...
          if (!SettBit)
              vksetCookie('remixbit', DefSetBits);  // vksetCookie РёР·РјРµРЅСЏРµС‚ SettBit, РµСЃР»Рё РёРјСЏ 'remixbit'
      }
	  if (!type) type=0;
   ...
   function vkRandomRange(start, end){return start + Math.round((end - start) * Math.random())}
	...
	Inj = { // KiberInfinity's JS_InjToFunc_Lib v2.1
      ...
      Parse : function (func) {
         // РѕРїСЂРµРґРµР»РµРЅРёРµ СЂР°СЃРїР°СЂСЃРёС‚СЊ РїРµСЂРµРґР°РЅРЅСѓСЋ С„СѓРЅРєС†РёСЋ РёР»Рё Р¶Рµ РЅР°Р№С‚Рё РїРѕ РёРјРµРЅРё С„СѓРЅРєС†РёРё.
         ...
         return {
            func_name : func, // РґР»СЏ РїРѕСЃР»РµРґСѓСЋС‰РµРіРѕ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РІ Make, С„СѓРЅРєС†РёСЏ РґРѕР»Р¶РЅР° Р±С‹С‚СЊ РїРµСЂРµРґР°РЅР° РІ Parse РїРѕ СЃС‚СЂРѕРєРѕРІРѕРјСѓ РёРјРµРЅРё, Р»РёР±Рѕ РѕР±СЏР·Р°С‚РµР»СЊРЅРѕ РїРµСЂРµРѕРїСЂРµРґР»РµРЅРёРµ СЌС‚РѕРіРѕ РїР°СЂР°РјРµС‚СЂР° РЅР° РЅСѓР¶РЅРѕРµ СЃС‚СЂРѕРєРѕРІРѕРµ РёРјСЏ.
            func: fn,
            wrapper: wrp,
            full : res[0],
            args : res[1],
            code : res[2],
            args_names : res[1].split(/\s*,\s*/) // РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РјР°РєСЂРѕР·Р°РјРµРЅС‹ РѕР±РѕР·РЅР°С‡РµРЅРЅС‹С… Р°СЂРіСѓРјРµРЅС‚РѕРІ РІ РєРѕРґРµ
         }
      },
		Make : function (parsed_func, code, args) {
			var h = Array.prototype.join.call(args, '#_#');
			var hs = h.replace(/[^A-Za-z0-9]+/g, ""); // РіРµРЅРµСЂРёРј "С…РµС€" РёРЅСЉРµРєС†РёРё. РЅРµ РёРґРµР°Р»СЊРЅРѕ, РЅРѕ С‚Р°Рє Р±С‹СЃС‚СЂРµРµ, С‡РµРј crc/md5 Рё Рё.Рґ СЃС‡РёС‚Р°С‚СЊ.
			if (code.indexOf(hs) != -1) // РїСЂРѕРІРµСЂСЏРµРј, РµСЃР»Рё Р»Рё СѓР¶Рµ РјРµС‚РєР° СЌС‚РѕР№ РёРЅСЉРµРєС†РёРё РІ С„СѓРЅРєС†РёРё.
				return false;            // РµСЃР»Рё РёРЅСЉРµРєС†РёСЏ СѓР¶Рµ Р±С‹Р»Р° СЃРґРµР»Р°РЅР° СЂР°РЅРµРµ, С‚Рѕ СѓС…РѕРґРёРј.

			// РџРѕРґСЃС‚Р°РЅРѕРІРєР° РёРјС‘РЅ Р°СЂРіСѓРјРµРЅС‚РѕРІ РІ РјРµСЃС‚Р° СѓРєР°Р·Р°РЅРЅС‹Рµ РІ РЅРѕРІРѕРј РєРѕРґРµ РєР°Рє #ARG1#, #ARG2# РёР»Рё __ARG0__, __ARG1__ Рё С‚.Рґ
			code = code.replace(/(#|__)ARG(\d+)\1/g, function (s, prefix, idx) {
					var arg_idx = parseInt(idx);
					return parsed_func.args_names[arg_idx];
				});
				var ac = '\n"[inj_label]' + hs + '";';
				// РґРѕР±Р°РІР»СЏРµРј РєРѕСЃРјРµС‚РёС‡РµСЃРєРёР№ РїРµСЂРµРЅРѕСЃ СЃС‚СЂРѕРєРё РїРµСЂРµРґ СЂРѕРґРЅС‹Рј РєРѕРґРѕРј:
				if (!/^[\r\n\s]*['"]\[inj_label\]/.test(code))
					ac += '\n';
				// РїРµСЂРµР·Р°РїРёСЃС‹РІР°РµРј С„СѓРЅРєС†РёСЋ РЅРѕРІРѕР№:
      ...
      Wrap : function(func){
		...
		Start : function (func, inj_code) {
         ...
         return new_func;
         /*
			if (isFunction(inj_code))                 // РЅСѓ Р° С‡С‚Рѕ? Inj Рё С‚Р°Рє РєРѕСЃС‚С‹Р»СЊ, Р° СЃ СЌС‚РёРј СѓРґРѕР±РЅРµР№ РјРµСЃС‚Р°РјРё - РїРµСЂРµРґР°Р»Рё РёРЅС‚РµСЂРµСЃСѓСЋС‰РёР№ РЅР°СЃ Р»РѕРіРёС‡РµСЃРєРё Р·Р°РІРµСЂС€С‘РЅРЅС‹Р№ РєРѕРґ Р·Р°РІС‘СЂРЅСѓС‚С‹Рј РІ Р°РЅРѕРЅРёРјРЅСѓСЋ С„СѓРЅРєС†РёСЋ
				inj_code = Inj.Parse(inj_code).code;   // Рё РІС‹РґСЂР°Р»Рё РµРіРѕ РёР· РЅРµС‘, Р° РЅРµ СЃС‚СЂРѕРєРѕР№ СЃ СЌРєСЂР°РЅРёСЂРѕРІР°РЅРёСЏРјРё, Р±РµР· РїРµСЂРµРЅРѕСЃРѕРІ Рё С‚.Рґ
   ...
   vk_lib.get_block_comments = function(func){ // РёР·РІР»РµРєР°РµРј РёР· РєРѕРґР° С„СѓРЅРєС†РёРё СЃРѕРґРµСЂР¶РёРјРѕРµ Р±Р»РѕРєРѕРІС‹С… РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ
      var code = Inj.Parse(func).code;
      var obj_rx = /\*([a-z0-9_]+):\s*([\s\S]+?)\s*\*\//ig; // РїСЂРё РЅР°С…РѕР¶РґРµРЅРёРё /*comment_name: СЃРѕРґРµСЂР¶РёРјРѕРµ */ РІСЃС‘ Р±СѓРґРµС‚ СЂР°СЃРїР°СЂСЃРµРЅРЅРѕ РІ РѕР±СЉРµРєС‚ {comment_name: СЃРѕРґРµСЂР¶РёРјРѕРµ}
      var arr_rx = /\*(\s*)([\s\S]+?)\s*\*\//g;             // РёРЅР°С‡Рµ РІСЃС‘ Р±СѓРґРµС‚ РІ РІРёРґРµ РјР°СЃСЃРёРІР°
      var is_obj = obj_rx.test(code);
      var comments = is_obj ? {} : [];
      code.replace(is_obj ? obj_rx : arr_rx,function(s,name,comment){ // РїСЂРѕСЃС‚Рѕ РІР·СЏР» replace РІРјРµСЃС‚Рѕ while..regexp.exec
         if (is_obj)
   ...
   vk_lib.api = {
	...
	vkBroadcast={
		disabled:false,
		ignore_current_window:true, //РІРѕР·РјРѕР¶РЅРѕСЃС‚СЊ РѕС‚РєР»СЋС‡Р°С‚СЊ СЂРµР°РєС†РёСЋ РѕС‚СЃС‹Р»Р°СЋС‰РµР№ СЃРѕРѕР±С‰РµРЅРёРµ РІРєР»Р°РґРєРё СЂРµР°РіРёСЂРѕРІР°С‚СЊ РЅР° СЌС‚Рѕ Р¶Рµ СЃРѕРѕР±С‰РµРЅРёРµ.
...
/// begin color functions
   ...
   function hex2rgba(hexcolor,ret_struct){  // РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РїСЂРё СЂР°Р·СЂР°Р±РѕС‚РєРµ С‚РµРј РѕС„РѕСЂРјР»РµРЅРёСЏ
...
/* VK GUI */
	//javascript:   var x=0;  setInterval("ge('content').innerHTML=vkProgressBar(x++,100,600,'Р’С‹РїРѕР»РЅРµРЅРѕ %');",100);  void(0);
...
function vk_oauth_api(app_id,scope){
   var api = {
      ...
      auth:function(callback){
         ...
         // Р”Р»СЏ http://vk.com РїСЂРё РЅР°Р»РёС‡РёРё СЃРѕРµРґРёРЅРµРЅРёСЏ СЃ background.js РёСЃРїРѕР»СЊР·СѓРµРј Р·Р°РїСЂРѕСЃС‹ Рє https С‡РµСЂРµР· background
         ...
         XFR.post(auth_url,{},function(t){
            ...
            var onmess=function(event) {
                  ...
                  var data=(event.data || {});
                  // РџРѕР»СѓС‡РёР»Рё СЃРѕРѕР±С‰РµРЅРёРµ РѕС‚ РЅР°С€РµРіРѕ С„СЂРµР№РјР°, Р° РЅРµ РѕС‚ РґСЂСѓРіРѕР№ РєРѕРїРёРё СЌС‚РѕРіРѕ РєР»Р°СЃСЃР°
      ...
      call:function(method, inputParams, callback, captcha){
         ...
         if (vk_ext_api.ready && ((location.protocol == 'http:') || (location.hostname != 'vk.com')) && (api.protocol == 'https:')){ //РЅР° new.vk.com РЅРµ РјРѕР¶РµРј СЃС‚СѓС‡Р°С‚СЊ РЅР° СЂРѕСѓС‚ /api.php
            vk_aj.post('https://api.vk.com/method/'+method, params, onDoneRequest);
         } else {
            if (api.protocol != 'https:'){
               // СЃ sid'РѕРј РїСЂРѕР±Р»РµРјС‹ СЃ РіРµРЅРµСЂР°С†РёРµР№ РїРѕРґРїРёСЃРё РґР»СЏ Р·Р°РїСЂРѕСЃРѕРІ СЃ РїСЂРѕРёР·РІРѕР»СЊРЅС‹Рј С‚РµРєСЃС‚РѕРј - РѕРЅ РїРµСЂСЃС‚Р°С‘С‚ Р±С‹С‚СЊ РІР°Р»РёРґРЅС‹Рј
               // С‡Р°СЃС‚СЊ РєРѕСЃС‚С‹Р»РµР№ РІРёРґР° replace(/%20/g,'+') РјРѕР¶РЅРѕ СѓРІРёРґРµС‚СЊ РЅРёР¶Рµ, РЅРѕ РЅР°РґРѕ Р°РґРµРєРІР°С‚РЅРѕРµ СЂРµС€РµРЅРёРµ.
               var sig = [];
            ...
            params['oauth'] = 1;
            AjPost('/api.php', params, function(text){ // https://new.vk.com/api.php СЂРµРґРёСЂРµРєС‚РёС‚ РЅР° https://vk.com/api.php => С‚СѓС‚ С„РµР№Р» РєСЂРѕСЃСЃРґРѕРјРµРЅРЅРѕСЃС‚Рё
               onDoneRequest(text);
            })
         }
...
var vk_api_permissions = {
   ...
   // РџСЂРµРѕР±СЂР°Р·СѓРµС‚ С‡РёСЃР»РѕРІС‹Рµ РїСЂР°РІР° РґРѕСЃС‚СѓРїР° РїСЂРёР»РѕР¶РµРЅРёСЏ РІ СЃС‚СЂРѕРєСѓ, РіРґРµ РїСЂР°РІР° СЂР°Р·РґРµР»С‘РЅРЅС‹ Р·Р°РїСЏС‚РѕР№
   ...
   // РџСЂРµРѕР±СЂР°Р·СѓРµС‚ С‡РёСЃР»РѕРІС‹Рµ РїСЂР°РІР° РґРѕСЃС‚СѓРїР° РїСЂРёР»РѕР¶РµРЅРёСЏ РІ С‡РёСЃР»Рѕ
...
function vkApiCall(method,params,callback){ // Р¤СѓРЅРєС†РёСЏ РїРѕР·РІРѕР»СЏРµС‚ СЋР·Р°С‚СЊ РјРµС‚РѕРґС‹ Р±РµР· Р°РІС‚РѕСЂРёР·Р°С†РёРё. TODO: РґРѕР±Р°РІРёС‚СЊ РїРѕР»СѓС‡РµРЅРёРµ РёРЅС„С‹ С‡РµСЂРµР· СЌС‚Сѓ С„СѓРЅРєС†РёСЋ РґР»СЏ РІСЃРїР»С‹РІР°СЋС‰РµРіРѕ РїСЂРѕС„РёР»СЏ, РµСЃР»Рё С‚РµР±СЏ СЌС‚РѕС‚ С‡РµР» РІ СЃРІРѕР№ Р§РЎ Р·Р°РЅС‘СЃ.
   params = params || {};
   params['oauth'] = 1;
   params['method'] = method;
...
vkApis={
    /* РїРѕР»СѓС‡РµРЅРёРµ РІСЃРµС… С„РѕС‚РѕРіСЂР°С„РёР№ РёР· Р°Р»СЊР±РѕРјР° aid РІР»Р°РґРµР»СЊС†Р° oid С‡РµСЂРµР· API.
     * callback: function( [{pid, src}, ...] )
     * progress: function(cur, total)
     */
    photos: function (oid, aid, callback, progress) {
        var result = [];
        var total = 0;      // РћР±С‰РµРµ РєРѕР»РёС‡РµСЃС‚РІРѕ С„РѕС‚РѕРіСЂР°С„РёР№
        var PER_REQ = 1000; // РћРіСЂР°РЅРёС‡РµРЅРёРµ Р’РєРѕРЅС‚Р°РєС‚Р° (СЃРј. https://vk.com/dev/photos.get)
        var run = function (i) {
            ...
            dApi.call('photos.get', params, function (r) {
                ...
                if (++i * PER_REQ < total)  //РЈСЃР»РѕРІРёРµ РїСЂРѕРґРѕР»Р¶РµРЅРёСЏ СЂРµРєСѓСЂСЃРёРё - РєРѕР»РёС‡РµСЃС‚РІРѕ РѕР±СЂР°Р±РѕС‚Р°РЅРЅС‹С… Р·Р°РїРёСЃРµР№ РјРµРЅСЊС€Рµ РѕР±С‰РµРіРѕ РєРѕР»РёС‡РµСЃС‚РІР°
                    run(i);
                else
                    callback(result);
            });
		...
		var get=function(){
            ...
            onDone: function(listId, ph_count, offset, data) {
               ...
               for(var i=0; i<data.length;i++){
                  ...
                  //p.max_src=max_src;
                  //p.album = '<a href="/album-22786271_124932410" onclick="return nav.go(this, event)">РђР РҐРР’ (9)</a>'
                  //p.desc = ''
                  if (max_src){
                     if (opts.info){
               ...
               if (cur<Math.min(to,count)){
                  cur+=PER_REQ;
                  setTimeout(nxt,50); // Р°РєС‚РёРІРёСЂСѓРµРј РєРѕСЃС‚С‹Р»СЊ
                  //setTimeout(get,50);
            ...
            onFail: function(){
               ...
               setTimeout(function(){next=true;},5000); // Р°РєС‚РёРІРёСЂСѓРµРј РєРѕСЃС‚С‹Р»СЊ
            }
         });
		};
      var next=true;
      var nxt=function(){next=true;};
      setInterval(function(){ // Р·РЅР°СЋ... СЌС‚РѕС‚ СѓР¶Р°СЃРЅС‹Р№ РєРѕСЃС‚С‹Р»СЊ РґР»СЏ РёР·Р±РµР¶Р°РЅРёСЏ РЅР°СЂР°С‰РёРІР°РЅРёСЏ СЃС‚РµРєР° РІС‹Р·РѕРІРѕРІ...
         if (!next) return;
         next=false;
         get();
      },100);
    ...
    /* РїРѕР»СѓС‡РµРЅРёРµ РІСЃРµС… С„РѕС‚РѕРіСЂР°С„РёР№ РІР»Р°РґРµР»СЊС†Р° oid СЃ РіСЂСѓРїРїРёСЂРѕРІРєРѕР№ РїРѕ Р°Р»СЊР±РѕРјР°Рј.
     * callback: function( [{title, list: [{pid, src}, ...]}, ...] )
     * progress: function(cur, total) РґР»СЏ Р°Р»СЊР±РѕРјРѕРІ Рё С„РѕС‚РѕРє РІРЅСѓС‚СЂРё РЅРёС…
     */
    albums: function (oid, callback, progress_albums, progress_photos) {
        var result = [];
        var data;   // Р·РґРµСЃСЊ Р±СѓРґРµС‚ РёРЅС„Р° РѕР± Р°Р»СЊР±РѕРјР°С…, РїРѕР»СѓС‡РµРЅРЅР°СЏ РёР· API
        var run = function (i) {
            if (isFunction(progress_albums)) progress_albums(i, data.length);
            if (i == data.length)   // СѓСЃР»РѕРІРёРµ РѕРєРѕРЅС‡Р°РЅРёСЏ СЂРµРєСѓСЂСЃРёРё
                callback(result);
            else if (data[i].size > 0) {
                switch (data[i].id) {  // Р·Р°РјРµРЅР° РѕС‚СЂРёС†Р°С‚РµР»СЊРЅС‹С… Р°Р№РґРёС€РЅРёРєРѕРІ СЃРёСЃС‚РµРјРЅС‹С… Р°Р»СЊР±РѕРјРѕРІ РЅР° РїСЂРёРіРѕРґРЅС‹Рµ Рє СЃРєР°С‡РёРІР°РЅРёСЋ.
                ...
                vkApis.photos(oid, data[i].id, function (_list) {
                    ...
                    run(++i);   // РїСЂРѕРґРѕР»Р¶РµРЅРёРµ СЂРµРєСѓСЂСЃРёРё. СЂРµРєСѓСЂСЃРёСЏ Р·РґРµСЃСЊ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РїСЂРµРІСЂР°С‰РµРЅРёСЏ Р°СЃРёРЅС…СЂРѕРЅРЅРѕРіРѕ С†РёРєР»Р° РІ СЃРёРЅС…СЂРѕРЅРЅС‹Р№.
                }, progress_photos);
            } else run(++i);
        };
        ...
        dApi.call('photos.getAlbums', {owner_id: oid, need_system: 1}, function (r) { ////TODO: upgrade version
            ...
            if (data) run(0);   // Р·Р°РїСѓСЃРє СЂРµРєСѓСЂСЃРёРё СЃ РїРµСЂРІРѕРіРѕ Р°Р»СЊР±РѕРјР°.
...
var vk_ext_msg = {
   ...
   init:function(callback){
      ...
      if (typeof CustomEvent != 'undefined'){
         ...
         /* РґР»СЏ СЌС‚РѕРіРѕ СЃР»СѓС‡Р°СЏ vk_ext_msg.handler РІС‹Р·С‹РІР°РµС‚СЃСЏ РІ  vk_ext_msg.post_message
...
var vk_ext_api={
   ...
   init:function(){
      if (!vk_ext_api.inited){
         //window.addEventListener("message", vk_ext_api.on_message,false); // РЅРµ РЅСЂР°РІРёС‚СЃСЏ РЅРµРєРѕС‚РѕСЂС‹Рј Р±СЂР°СѓР·РµСЂР°Рј С‚Р°РєРѕР№ СЃРїРѕСЃРѕР± РѕР±С‰РµРЅРёСЏ СЃ РєРѕРЅС‚РµРЅС‚-СЃРєСЂРёРїС‚РѕРј (СЏРєРѕР±С‹ СѓСЃС‚Р°СЂРµРІС€РёР№)
         //РїРѕСЃР»РµРґРЅСЏСЏ РІРµСЂСЃРёСЏ СЃР°С„Р°СЂРё РґРѕСЃС‚СѓРїРЅР°СЏ РЅР° РІРёРЅРґРµ РЅРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚ CustomEvent, С‚.С‡ РЅСѓР¶РЅС‹ Рё РєРѕСЃС‚С‹Р»Рё Рё РїРѕ СЃС‚Р°СЂРёРЅРєРµ
   ...
   */
   storage:{
      ...
      // Р§С‚РµРЅРёРµ Рё СѓСЃС‚Р°РЅРѕРІРєР° Р·РЅР°С‡РµРЅРёР№ СЃСЂР°Р·Сѓ РЅРµСЃРєРѕР»СЊРєРёС… РїРѕР»РµР№
...
function vkOnResizeSaveBtn(w,h){        // Р’С‹Р·С‹РІР°РµС‚СЃСЏ РёР· С„Р»РµС€РєРё РєР°Рє Рё vkOnSaveDebug
...
function vkSaveText(text,fname){
    if (getSet(103)=='y') { // РЎРѕС…СЂР°РЅРµРЅРёРµ С„Р°Р№Р»Р° РёСЃРїРѕР»СЊР·СѓСЏ HTML5 С„СѓРЅРєС†РёСЋ saveAs
        vkLdr.show();
...
// РџРѕРґРєР»СЋС‡РµРЅРёРµ Р±РёР±Р»РёРѕС‚РµРєРё FileSaver.js Рё РїРѕСЃР»РµРґСѓСЋС‰РµРµ РІС‹РїРѕР»РЅРµРЅРёРµ С„СѓРЅРєС†РёРё callback
function FileSaverConnect(callback) {
    var FileSaverOnload = function () {
        try {
            var blobSupported = !!URL.createObjectURL;  // РџСЂРѕРІРµСЂРєР° РїРѕРґРґРµСЂР¶РєРё Blob РґР»СЏ РїРѕРґРєР»СЋС‡РµРЅРёСЏ Blob.js РІ СЃС‚Р°СЂС‹С… Р±СЂР°СѓР·РµСЂР°С… (Opera < 15 Рё Firefox < 20)
        } catch (e) {}
        if (!blobSupported)
    ...
    if (typeof saveAs != "undefined")   // РџСЂРѕРІРµСЂРєР° РїРѕРґРґРµСЂР¶РєРё saveAs
        FileSaverOnload();
    else                                // РµСЃР»Рё РѕРЅР° РЅРµ СЂРµР°Р»РёР·РѕРІР°РЅР° Р±СЂР°СѓР·РµСЂРѕРј, РїРѕРґРєР»СЋС‡Р°РµРј Р±РёР±Р»РёРѕС‚РµРєСѓ
        AjCrossAttachJS('http://vkopt.net/FileSaver', 'FileSaver', FileSaverOnload);
}

// РџРѕРґРєР»СЋС‡РµРЅРёРµ Р±РёР±Р»РёРѕС‚РµРєРё JsZip Рё РїРѕСЃР»РµРґСѓСЋС‰РµРµ РІС‹РїРѕР»РЅРµРЅРёРµ С„СѓРЅРєС†РёРё callback
...
function vkAlertBox(title, text, callback, confirm, minimizable) {// [callback] - "Yes" or "Close" button / onShow() for "minimizable"; [confirm] - "No" button
  if (minimizable && vkopt.settings.get('minimizable_boxes')) {    // РІС‹РІРѕРґ РєРѕРЅС‚РµРЅС‚Р° РІ РІРёРґРµРѕРїР»РµРµСЂРµ, РєРѕС‚РѕСЂС‹Р№ РјРѕР¶РЅРѕ СЃРІРѕСЂР°С‡РёРІР°С‚СЊ
      ...
      stManager.add(['videoview.js', 'videoview.css', 'page.js', 'page.css'], function () {
          var _a = window.audioPlayer;  // Р”Р»СЏ РїСЂРµРґРѕС‚РІСЂР°С‰РµРЅРёСЏ РѕСЃС‚Р°РЅРѕРІРєРё Р°СѓРґРёРѕ РїСЂРё РѕС‚РєСЂС‹С‚РёРё РІРёРґРµРѕРїР»РµРµСЂР°
          window.audioPlayer = null;
          videoview.show(false, '0_', '', {noHistory: 1, prevLoc: nav.objLoc});
          window.audioPlayer = _a;      // РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёРµ Р°СѓРґРёРѕРїР»РµРµСЂР°
          mvcur.mvContent.appendChild(vp);
          hide(mvcur.mvLoader, mvcur.mvControls); // СЃРєСЂС‹С‚СЊ РєР°СЂС‚РёРЅРєСѓ СЃ Р°РЅРёРјР°С†РёРµР№ Р·Р°РіСЂСѓР·РєРё Рё Р±Р»РѕРє РґР»СЏ РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ
          if (title) {  // Р·Р°РіРѕР»РѕРІРѕРє Р±СѓРґРµС‚ РѕС‚РѕР±СЂР°Р¶Р°С‚СЊСЃСЏ С‚РѕР»СЊРєРѕ РІ СЃРІРµСЂРЅСѓС‚РѕРј РѕРєРЅРµ.
      ...
      return {
          setOptions: function (items) {    // РґР»СЏ СЃРѕРІРјРµСЃС‚РёРјРѕСЃС‚Рё СЃ MessageBox
              for (var i in items)
